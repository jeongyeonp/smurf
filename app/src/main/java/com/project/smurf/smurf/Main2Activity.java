...
public class Main2Activity extends AppCompatActivity {
    ...
    private Button but_foodinfo;
    public static String Jfood="";
    public static Intent intent1=new Intent();
    public static String jfood;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(view -> {
            ...
            builder.setPositiveButton(R.string.dialog_select_gallery, (dialog, which) -> startGalleryChooser());
            builder.setNegativeButton(R.string.dialog_select_camera, (dialog, which) -> {
                startCamera();
            });
            builder.create().show();
        });
        ...
        //음식정보 상세보기
        but_foodinfo = (Button) findViewById(R.id.but_foodinfo);
    ...
    public static class LableDetectionTask extends AsyncTask<Object, Void, String> {
        private final WeakReference<Main2Activity> mActivityWeakReference;
        private Vision.Images.Annotate mRequest;

        LableDetectionTask(Main2Activity activity, Vision.Images.Annotate annotate) {
        ...
        protected String doInBackground(Object... params) {
            try {
                ...
                Jfood=convertResponseToString(response);
                return Jfood;
        ...
        protected void onPostExecute(String result) {
            Main2Activity activity = mActivityWeakReference.get();
            if (activity != null && !activity.isFinishing()) {
                TextView imageDetail = activity.findViewById(R.id.image_details);
                jfood=result;
                imageDetail.setText(jfood);
            }
        }
    }
